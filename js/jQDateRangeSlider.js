    ...
    function a(a, d, e, f) {
        ...
        this.CacheElement = function(a, b) {
            ...
            b.margin = {
                ...
                right: this.ParsePixels("marginRight",
                    a)
            };
            b.border = {
        ...
        this.PositionLabel = function(a, b, c) {
            ...
            d - b >= 0 ? (a.css("right", ""), a.offset({
                left: b
            })) : (d += this.cache.offsetParent.width, b = b + c.margin.left + c.outerWidth + c.margin.right, b = d - b, a.css("left", ""), a.css("right", b))
        };
        ...
        this.GetRawPosition = function(a, b) {
            var c = b.offset.left + b.outerWidth / 2,
                d = c - a.outerWidth / 2,
                e = d - a.margin.left - a.border.left;
            return {
                left: d,
                outerLeft: e,
...
(function(c) {
    c.widget("ui.rangeSliderHandle", c.ui.rangeSliderDraggable, {
        ...
        _setOption: function(a, b) {
            if (a === "isLeft" && (b === !0 || b === !1) && b != this.options.isLeft) this.options.isLeft = b, this.element.toggleClass("ui-rangeSlider-leftHandle", this.options.isLeft).toggleClass("ui-rangeSlider-rightHandle", !this.options.isLeft), this._position(this._value), this.element.trigger("switch", this.options.isLeft);
            else if (a === "step" && this._checkStep(b)) this.options.step = b, this.update();
            else if (a === "bounds") this.options.bounds = b, this.update();
            else if (a === "range" && this._checkRange(b)) this.options.range =
                b, this.update();
        ...
        _initElement: function() {
            ...
            this.cache.parent.width === 0 || this.cache.parent.width === null ? setTimeout(c.proxy(this._initElement, this),
                500) : (this._position(this._value), this._triggerMouseEvent("initialize"))
        },
        _bounds: function() {
...
(function(c) {
    c.widget("ui.rangeSlider", {
        ...
        _setOption: function(a, b) {
            if (a === "wheelMode" || a === "wheelSpeed") this._bar("option", a, b), this.options[a] = this._bar("option", a);
            else if (a === "arrows" && (b === !0 || b === !1) && b !== this.options.arrows) this._setArrowsOption(b);
            else if (a === "valueLabels") this._setLabelsOption(b);
            else if (a === "durationIn" || a === "durationOut" ||
                a === "delayOut") this._setLabelsDurations(a, b);
            else if (a === "formatter" && b !== null && typeof b === "function") this.options.formatter = b, this.options.valueLabels !== "hide" && (this._destroyLabels(), this._createLabels());
            else if (a === "bounds" && typeof b.min !== "undefined" && typeof b.max !== "undefined") this.bounds(b.min, b.max);
            else if (a === "range") this._bar("option", "range", b), this.options.range = this._bar("option", "range"), this._changed(!0);
            else if (a === "step") this.options.step = b, this._leftHandle("option", "step", b), this._rightHandle("option",
                "step", b), this._changed(!0)
        },
        ...
        _setLabelsOption: function(a) {
            if (!(a !== "hide" && a !== "show" && a !== "change")) this.options.valueLabels = a, a !== "hide" ? (this._createLabels(), this._leftLabel("update"), this._rightLabel("update")) : this._destroyLabels()
        },
        _setArrowsOption: function(a) {
            if (a === !0) this.element.removeClass("ui-rangeSlider-noArrow").addClass("ui-rangeSlider-withArrows"), this.arrows.left.css("display", "block"), this.arrows.right.css("display",
                "block"), this.options.arrows = !0;
            else if (a === !1) this.element.addClass("ui-rangeSlider-noArrow").removeClass("ui-rangeSlider-withArrows"), this.arrows.left.css("display", "none"), this.arrows.right.css("display", "none"), this.options.arrows = !1;
            this._initWidth()
        },
        ...
        _createHandle: function(a) {
            return c("<div />")[this._handleType()](a).bind("sliderDrag",
                c.proxy(this._changing, this)).bind("stop", c.proxy(this._changed, this))
        },
        _createBar: function() {
            ...
            this.options.range = this._bar("option",
                "range");
        ...
        _createArrow: function(a) {
            var b = c("<div class='ui-rangeSlider-arrow' />").append("<div class='ui-rangeSlider-arrow-inner' />").addClass("ui-rangeSlider-" + a + "Arrow").css("position", "absolute").css(a, 0).appendTo(this.element),
                a = a === "right" ? c.proxy(this._scrollRightClick, this) : c.proxy(this._scrollLeftClick, this);
        ...
        _updateValues: function() {
            var a = this._leftHandle("value"),
                ...
                c = this._min(a, b),
                e = this._max(a, b),
                c = c !== this._values.min || e !== this._values.max;
        ...
        _createLabels: function() {
            ...
            this.labels.right =
                this._createLabel(this.labels.right, this.rightHandle);
        ...
        bounds: function(a, b) {
            typeof a !== "undefined" &&
                typeof b !== "undefined" && parseFloat(a) === a && parseFloat(b) === b && a < b && (this._setBounds(a, b), this._changed(!0));
            return this.options.bounds
        },
...
(function(c) {
    c.widget("ui.dateRangeSliderHandle", c.ui.rangeSliderHandle, {
        ...
        _setOption: function(a, b) {
            a === "step" ? (this.options.step = b, this._createSteps(), this.update()) : (c.ui.rangeSliderHandle.prototype._setOption.apply(this, [a, b]), a === "bounds" && this._createBoundsValues())
        },
        ...
        _createSteps: function() {
            if (this.options.step === !1 || !this._isValidStep()) this._steps = !1;
            else {
        ...
        _round: function(a) {
            ...
            if (c >= this._steps.length - 1) return this._steps[this._steps.length - 1];
            else if (c == 0) return this._steps[0];
            b = this._steps[c];
            c = this._steps[c + 1];
            if (a - b < c - a) return b;
            return c
...
(function(c) {
    c.widget("ui.dateRangeSlider", c.ui.rangeSlider, {
        ...
        values: function(a, b) {
            var d = null,
                d = typeof a !== "undefined" && typeof b !== "undefined" && a instanceof Date && b instanceof Date ? c.ui.rangeSlider.prototype.values.apply(this, [a.valueOf(), b.valueOf()]) : c.ui.rangeSlider.prototype.values.apply(this, this._toArray(arguments));
            return {
                min: new Date(d.min),
                max: new Date(d.max)
            }
