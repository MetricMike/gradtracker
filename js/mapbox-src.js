  ...
  (function (t, e, i) {
    ...
    2: [function (t, e) {
      e.exports = {
        ...
        main: "index.js",
        dependencies: {
          leaflet: "git://github.com/Leaflet/Leaflet.git#72ac52cf4682d0e5a6ac2f598879f80233862746",
          mustache: "~0.7.2",
          corslite: "0.0.3",
          json3: "~3.2.4"
        },
        ...
        (function (e, n, o) {
          ...
          r.version = "0.6-dev", "object" == typeof i && "object" == typeof i.exports ? i.exports = r : "function" == typeof t && t.amd && t("leaflet", [], function () {
            ...
            var n = 0,
             ...
             a = e.cancelAnimationFrame || t("CancelAnimationFrame") || t("CancelRequestAnimationFrame") ||
             function (t) {
                e.clearTimeout(t)
             };
          ...
          r.Mixin = {}, r.Mixin.Events = {
            addEventListener: function (t, e, i) {
              ...
              var n, o, s, l, h, u, c, p = this[a] = this[a] || {},
               d = i && r.stamp(i);
            ...
            removeEventListener: function (t, e, i) {
              ...
              var n, o, s, l, h, u, c, p, d, m = this[a],
               f = i && r.stamp(i);
              for (t = r.Util.splitWords(t), n = 0, o = t.length; o > n; n++) if (s = t[n], u = s + "_idx", c = u + "_len", p = m[u], e) {
                if (l = i && p ? p[f] : m[s]) {
                  for (h = l.length - 1; h >= 0; h--) l[h].action !== e || i && l[h].context !== i || (d = l.splice(h, 1), d[0].action = r.Util.falseFn);
                  i && p && 0 === l.length && (delete p[f], m[c]--)
                }
              } else delete m[s], delete m[u];
              return this
            },
            ...
            fireEvent: function (t, e) {
              ...
              s = u[t + "_idx"];
              for (l in s) if (i = s[l].slice()) for (n = 0, o = i.length; o > n; n++) i[n].action.call(i[n].context || this, h);
              return this
            },
            ...
            testProp: function (t) {
              for (var e = n.documentElement.style, i = 0; t.length > i; i++) if (t[i] in e) return t[i];
              return !1
            },
            ...
            initialize: function (t, e) {
              e = r.setOptions(this, e), this._initContainer(t), this._initLayout(), this._initEvents(), e.maxBounds && this.setMaxBounds(e.maxBounds), e.center && e.zoom !== o && this.setView(r.latLng(e.center), e.zoom, {
                reset: !0
            ...
            getBoundsZoom: function (t, e, i) {
              ...
              var n, o = this.getMinZoom() - (e ? 1 : 0),
               ...
               u = !0;
              i = r.point(i || [0, 0]);
              do o++, n = this.project(h, o).subtract(this.project(l, o)).add(i), u = e ? n.x < a.x || n.y < a.y : a.contains(n);
              while (u && s >= o);
            ...
            _updateOpacity: function () {
              ...
              if (r.Browser.webkit) for (t in e) e[t].style.webkitTransform += " translate(0,0)"
            },
            _initContainer: function () {
              ...
              if (!this._container) {
                if (this._container = r.DomUtil.create("div", "leaflet-layer"), this._updateZIndex(), this._animated) {
                  ...
                  this._bgBuffer = r.DomUtil.create("div", e, this._container), this._bgBuffer.style.zIndex = 1, this._tileContainer = r.DomUtil.create("div", e, this._container), this._tileContainer.style.zIndex = 2
            ...
            _addTilesFromCenterOut: function (t) {
              var e, i, o, s = [],
               a = t.getCenter();
              for (e = t.min.y; t.max.y >= e; e++) for (i = t.min.x; t.max.x >= i; i++) o = new r.Point(i, e), this._tileShouldBeLoaded(o) && s.push(o);
              var l = s.length;
              if (0 !== l) {
                s.sort(function (t, e) {
            ...
            createIcon: function () {
              var t = n.createElement("div"),
               e = this.options;
              return e.html !== !1 && (t.innerHTML = e.html), e.bgPos && (t.style.backgroundPosition = -e.bgPos.x + "px " + -e.bgPos.y + "px"), this._setIconStyles(t, "icon"), t
            },
            createShadow: function () {
              return null
            }
            ...
            removeLayer: function (t) {
              return t in this._layers && (t = this._layers[t]), t.off(r.FeatureGroup.EVENTS, this._propagateEvent, this), r.LayerGroup.prototype.removeLayer.call(this, t), this._popupContent && this.invoke("unbindPopup"), this.fire("layerremove", {
                layer: t
              })
            },
            bindPopup: function (t, e) {
          ...
          function () {
            ...
            initialize: function (t, e) {
              var i, n, o;
              if (r.Polyline.prototype.initialize.call(this, t, e), t && r.Util.isArray(t[0]) && "number" != typeof t[0][0]) for (this._latlngs = this._convertLatLngs(t[0]), this._holes = t.slice(1), i = 0, n = this._holes.length; n > i; i++) o = this._holes[i] = this._convertLatLngs(this._holes[i]), o[0].equals(o[o.length - 1]) && o.pop();
            ...
            addMsTouchListenerStart: function (t, e, i, o) {
              var s = "_leaflet_",
               r = this._msTouches,
               a = function (t) {
                  for (var e = !1, n = 0; r.length > n; n++) if (r[n].pointerId === t.pointerId) {
                    e = !0;
                    break
                  }
            ...
            _initLayout: function () {
              ...
              e.setAttribute("aria-haspopup", !0), r.Browser.touch ? r.DomEvent.on(e, "click", r.DomEvent.stopPropagation) : (r.DomEvent.disableClickPropagation(e), r.DomEvent.on(e, "mousewheel", r.DomEvent.stopPropagation));
            ...
            setView: function (t, e, i) {
              if (e = this._limitZoom(e), t = r.latLng(t), i = i || {}, this._panAnim && this._panAnim.stop(), this._loaded && !i.reset && i !== !0) {
            ...
            _tryAnimatedZoom: function (t, e, i) {
              ...
              if (i = i || {}, !this.options.zoomAnimation || i.animate === !1 || !r.DomUtil.TRANSITION || r.Browser.android23 || r.Browser.mobileOpera || Math.abs(e - this._zoom) > this.options.zoomAnimationThreshold) return !1;
              var n = this.getZoomScale(e),
               o = this._getCenterOffset(t)._divideBy(1 - 1 / n),
               s = this._getCenterLayerPoint()._add(o);
              return i.animate === !0 || this.getSize().contains(o) ? (this.fire("movestart").fire("zoomstart"), this._animateZoom(t, e, s, n), !0) : !1
            },
            _animateZoom: function (t, e, i, n, o) {
            ...
            _animateZoom: function (t) {
              ...
              e && (clearTimeout(this._clearBgBufferTimer), r.Util.falseFn(i.offsetWidth));
              var n = r.DomUtil.TRANSFORM,
               o = t.delta ? r.DomUtil.getTranslateString(t.delta) : i.style[n];
              i.style[n] = o + " " + r.DomUtil.getScaleString(t.scale, t.origin)
            },
            ...
            _prepareBgBuffer: function () {
              ...
              return e && i > .5 && .5 > n ? (t.style.visibility = "hidden", this._stopLoadingImages(t), o) : (e.style.visibility = "hidden", e.style[r.DomUtil.TRANSFORM] = "", this._tileContainer = e, e = this._bgBuffer = t, this._stopLoadingImages(e), o)
            },
              ...
              endTag: function (t, o) {
                ...
                if (e.ELEMENTS.hasOwnProperty(t)) {
                  ...
                  if (!(s & (e.eflags.EMPTY | e.eflags.FOLDABLE))) {
                    ...
                    } else for (r = i.length; --r >= 0 && i[r].orig !== t;);
                    if (0 > r) return;
    ...
    23: [function (e, i, n) {
      (function () {
        ...
        e("json") || (w || (P = Math.floor, b = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], E = function (t, e) {
          ...
          return n = o = null, l ? a = 2 == l ?
          function (t, e) {
            var n, o = {},
             s = "[object Function]" == r.call(t);
          ...
          if ("object" == typeof A && A) if (m = r.call(A), "[object Date]" != m || i.call(A, "toJSON"))"function" == typeof A.toJSON && ("[object Number]" != m && "[object String]" != m && "[object Array]" != m || i.call(A, "toJSON")) && (A = A.toJSON(t));
          else if (A > -1 / 0 && 1 / 0 > A) {
            if (E) {
          ...
          var n, o, s, a, l, h;
          if ("function" == typeof e || "object" == typeof e && e) if ("[object Function]" == r.call(e)) o = e;
          else if ("[object Array]" == r.call(e)) for (s = {}, a = 0, l = e.length; l > a; h = e[a++], ("[object String]" == r.call(h) || "[object Number]" == r.call(h)) && (s[h] = 1));
          ...
          for (var t, e, i, n, o, s = T, r = s.length; r > L;) if (t = s.charAt(L), "	\r\n ".indexOf(t) > -1) L++;
            ...
            if ('"' == t) {
              ...
              else if ("\\" == t) if (t = s.charAt(++L), '\\"/btnfr'.indexOf(t) > -1) e += m[t], L++;
              else if ("u" == t) {
          ...
          var n, s = t[e];
          if ("object" == typeof s && s) if ("[object Array]" == r.call(s)) for (n = s.length; n--;) y(s, n, i);
          else o(s, function (t) {
            y(s, t, i)
          });
          return i.call(t, e, s)
